            ...
            <div>
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-muted-foreground">Monitor your Dailsmart Token usage and quota</p>
                    </div>
                ...
                <Card className="mb-6">
                    <CardHeader>
                        <CardTitle>Dailsmart Model Credits</CardTitle>
                        <CardDescription>
                            These track usage of Dailsmart models using Dailsmart Service Keys.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {isLoadingCredits ? (
                            ...
                            <p className="text-muted-foreground">No Dailsmart service keys configured. Set up a service key in your model configuration to see usage.</p>
                        )}
                    </CardContent>
                </Card>
                                        ...
                                        <TableHeader>
                                            <TableRow className="bg-muted/50">
                                                ...
                                                <TableHead className="font-semibold text-right">
                                                    {organizationPricing?.price_per_second_usd ? 'Cost (USD)' : 'Dailsmart Tokens'}
                                                </TableHead>
